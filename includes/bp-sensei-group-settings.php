	...
	class Group_Extension_Course_Settings extends BP_Group_Extension {
		...
		function settings_screen_save( $group_id = NULL ) {
			...
			if ( isset( $_POST[ 'user_course_start' ] ) ) {
				$bp_sensei_course_activity['user_course_start'] = $_POST[ 'user_course_start' ];
			}
			if ( isset( $_POST[ 'user_course_end' ] ) ) {
				$bp_sensei_course_activity['user_course_end'] = $_POST[ 'user_course_end' ];
			}
			if ( isset( $_POST[ 'user_lesson_start' ] ) ) {
				$bp_sensei_course_activity['user_lesson_start'] = $_POST[ 'user_lesson_start' ];
			}
			if ( isset( $_POST[ 'user_lesson_end' ] ) ) {
				$bp_sensei_course_activity['user_lesson_end'] = $_POST[ 'user_lesson_end' ];
			}
			if ( isset( $_POST[ 'user_quiz_pass' ] ) ) {
				$bp_sensei_course_activity['user_quiz_pass'] = $_POST[ 'user_quiz_pass' ];
			}
			if ( isset( $_POST[ 'user_lesson_comment' ] ) ) {
				$bp_sensei_course_activity['user_lesson_comment'] = $_POST[ 'user_lesson_comment' ];
			}
