...
class BuddyPress_Sensei_Plugin {
    ...
    */
    ...
    public function bp_sensei_enqueue_styles() {
        // CSS > Main
        //wp_enqueue_style( 'sensei-buddypress', $this->assets_url . '/css/sensei-buddypress.css', array(), '1.0.8', 'all' );
        wp_enqueue_style( 'sensei-buddypress', $this->assets_url . '/css/sensei-buddypress.min.css', array(), '1.0.8', 'all' );
        // JS > Main
